...
Lyon Code of Conduct is distributed under a Creative Commons Attribution-ShareAlike 4.0 International (CC BY-SA 4.0) license. It is based on the Berlin Code of Conduct.

## Supporters

Those user groups and conferences support the Lyon Code of Conduct:

    Le Sequenceur
    Creative Code Lyon 
    
https://lyoncodeofconduct.fr/
